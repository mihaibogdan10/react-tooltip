...
## Usage
Importing the css file from src/styles.css into your project is required.

```html
<div data-tip>Hover me</div>
<Tooltip place="right" type="light">
  <div>Content seen on hover</div>
</Tooltip>
```
